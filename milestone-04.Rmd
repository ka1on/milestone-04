...
This is my Milestone 4 pdf document. More information can be found in my github repo.^[[Katie Cao Github Repo](https://github.com/ka1on/milestone-04)]. The error "! sh: pdflatex: command not found" found in my log prevents the pdf for being knit.
